...
for operator in operators
    ...
    funcs = quote 
        """ 
            $($f)(a::CertainScalar, b::AbstractUncertainValue; n::Int = 30000)
        ...
        """
        function $(f)(a::CertainScalar, b::AbstractUncertainValue; n::Int = 30000)
            $(elementwise_operator)(a.value, b, n)
        end

        """ 
            $($f)(a::AbstractUncertainValue, b::CertainScalar; n::Int = 30000)
        ...
        To tune the number of draws to `n`, use the `$($operator)(a, b, n::Int)` syntax.
        """
        function $(f)(a::AbstractUncertainValue, b::CertainScalar; n::Int = 30000)
            $(elementwise_operator)(a, b.value, n)
        end

        """ 
        $($f)(a::AbstractUncertainValue, b::CertainScalar; n::Int)
        ...
        This function is called with the `$($operator)(a, b, n::Int)` syntax.
            """
        function $(f)(a::AbstractUncertainValue, b::CertainScalar, n::Int)
            $(elementwise_operator)(a, b.value, n)
        end

        """ 
            $($f)(a::CertainScalar, b::AbstractUncertainValue, n::Int)
        ...
        This function is called with the `$($operator)(a, b, n::Int)` syntax.
        """
        function $(f)(a::CertainScalar, b::AbstractUncertainValue, n::Int)
            $(elementwise_operator)(a.value, b, n)
        end
    end
